...
/** Pulled from https://spdx.org/licenses/exceptions.json on 2026-06-04. */
const rawLicenseExceptions = {
...
/**
 * The list of non-deprecated license exceptions.
 *
 * @category Internal
 */
export const spdxExceptions: ReadonlyArray<string> = filterMap(
    rawLicenseExceptions.exceptions,
    (exception) => {
        return exception.licenseExceptionId;
    },
    (licenseId, {isDeprecatedLicenseId}) => !isDeprecatedLicenseId,
);
