...
/** Pulled from https://spdx.org/licenses/licenses.json on 2026-06-04. */
const rawLicenses = {
...
/**
 * The list of supported license ids.
 *
 * @category Internal
 */
export const spdxLicenseIds = rawLicenses.licenses.map((license) => license.licenseId);
